#requested_time_windows.py is saved under src/ and
#make sure the path /src is properly added to PYTHONPATH.
...
#####Mermaid acquization log files are ready under the the below path.
